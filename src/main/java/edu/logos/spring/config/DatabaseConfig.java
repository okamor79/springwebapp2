...
@EnableJpaRepositories(basePackages = "edu.logos.spring.repository")
@ComponentScan(basePackages = {"edu.logos.spring.repository","edu.logos.spring.service"})
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() throws PropertyVetoException {
        ...
        emf.setPackagesToScan(new String[] {"edu.logos.spring.entity"}); // Entity package
